...
const heroContentShell =
  'flex w-full min-h-0 flex-1 flex-col justify-center bg-transparent py-8 lg:py-9 xl:py-10 min-[1451px]:py-32 min-[1451px]:min-h-screen'
...
const heroContentWidth =
  'mx-auto w-full max-w-[min(100%,22rem)] self-center min-[400px]:max-w-[min(100%,24rem)] sm:max-w-[min(100%,26rem)] md:mx-0 md:max-w-[min(100%,29rem)] md:self-start lg:max-w-[min(100%,33rem)] xl:max-w-[min(100%,38rem)] 2xl:max-w-[min(100%,42rem)] min-[1451px]:max-w-[min(100%,46rem)]'
...
export function HeroSection() {
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[url('/Mesadetrabajo1.png')] bg-cover bg-no-repeat bg-[position:28%_center] md:bg-[position:22%_center] lg:bg-[position:18%_center] xl:bg-[position:15%_center] 2xl:bg-[position:12%_center]"
        aria-hidden
      />
      ...
      <div className={`relative z-10 flex w-full min-w-0 flex-col ${heroContentMinH}`}>
        <div className={`${landingMaxWidthBox} ${heroSectionHx} ${heroContentShell}`}>
          <div
            className={`flex min-w-0 flex-col items-center gap-3.5 rounded-2xl bg-white/70 px-3 py-5 text-center shadow-[0_16px_40px_rgba(16,24,40,0.16)] backdrop-blur-[2px] min-[400px]:gap-4 min-[400px]:px-4 sm:gap-5 sm:px-5 sm:py-6 md:ml-4 md:items-start md:text-left lg:ml-8 lg:gap-7 lg:px-6 lg:py-7 xl:ml-10 min-[1451px]:ml-12 min-[1451px]:gap-12 min-[1451px]:px-8 min-[1451px]:py-10 ${heroContentWidth}`}
          >
            ...
            <div className="flex w-full flex-col items-center gap-0">
              ...
              <p className={`m-0 ${headlineLine} text-brand-pink text-[1.08em]`}>
                en estas vacaciones
              </p>
            ...
            <div className="flex w-full flex-col items-center gap-3 sm:gap-3 min-[1451px]:gap-8">
              <a
                ...
                className="whatsapp-link group inline-flex w-full max-w-md min-h-0 shrink-0 flex-col items-stretch px-3.5 py-2 transition-[filter,transform] active:scale-[0.99] min-[400px]:px-4 min-[400px]:py-2.5 sm:px-5 sm:py-2.5 md:px-6 md:py-3 lg:px-6 lg:py-3 xl:px-7 xl:py-3 min-[1451px]:max-w-lg min-[1451px]:px-7 min-[1451px]:py-4"
                style={ctaFrameStyle}
              >
